...
<div class="row">
    <div class="col-lg-8 mx-auto grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Create Supply Line Material</h4>
                
                <form action="{{ route('admin.supply-materials.store') }}" method="POST" class="forms-sample">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('material_code') is-invalid @enderror" 
                               id="material_code" name="material_code" value="{{ old('material_code') }}" placeholder="Leave empty for auto-generation (MATERIAL_001)">
                        @error('material_code')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('material_name') is-invalid @enderror" 
                               id="material_name" name="material_name" value="{{ old('material_name') }}" required>
                        @error('material_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary me-2">
                            <i class="mdi mdi-content-save"></i> Create Material
                        </button>
