                ...
                <form action="{{ route('admin.fmc-material-settings.update', $fmcMaterialSetting) }}" method="POST" class="forms-sample">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="number" step="0.01" min="0" max="100" class="form-control tax-rate-input @error('hst_rate') is-invalid @enderror" id="hst_rate" name="hst_rate" value="{{ old('hst_rate', $fmcMaterialSetting->hst_rate ?? 5.00) }}">
                            @error('hst_rate')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-md-6 form-group">
                            <label for="pst_rate">PST Rate (%)</label>
                            <input type="number" step="0.01" min="0" max="100" class="form-control tax-rate-input @error('pst_rate') is-invalid @enderror" id="pst_rate" name="pst_rate" value="{{ old('pst_rate', $fmcMaterialSetting->pst_rate ?? 7.00) }}">
