            ...
            <div class="card-body">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <select class="form-control @error('building_system_id') is-invalid @enderror" id="building_system_id" name="building_system_id">
                                ...
                                @foreach(($systems ?? collect()) as $system)
                                    <option value="{{ $system->id }}" {{ (string) old('building_system_id', $findingTemplateSetting->building_system_id) === (string) $system->id ? 'selected' : '' }}>{{ $system->name }}</option>
                                @endforeach
                            </select>
                ...
                <script>
                    (function () {
                        ...
                        const selectedSubsystemId = "{{ old('building_subsystem_id', $findingTemplateSetting->building_subsystem_id) }}";
                        const selectedComponentId = "{{ old('building_component_id', $findingTemplateSetting->building_component_id) }}";
