                ...
                <form action="{{ route('admin.finding-template-settings.store') }}" method="POST" class="forms-sample">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control @error('photo_reference') is-invalid @enderror" id="photo_reference" name="photo_reference" value="{{ old('photo_reference') }}" placeholder="e.g., R01">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group">
                            ...
                            <select class="form-control @error('default_priority') is-invalid @enderror" id="default_priority" name="default_priority" required>
                                <option value="1" {{ old('default_priority') == '1' ? 'selected' : '' }}>1 - High</option>
                                <option value="2" {{ old('default_priority', '2') == '2' ? 'selected' : '' }}>2 - Medium</option>
                                <option value="3" {{ old('default_priority') == '3' ? 'selected' : '' }}>3 - Low</option>
                            </select>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" step="0.1" min="0" class="form-control @error('default_labour_hours') is-invalid @enderror" id="default_labour_hours" name="default_labour_hours" value="{{ old('default_labour_hours', 0) }}" required>
