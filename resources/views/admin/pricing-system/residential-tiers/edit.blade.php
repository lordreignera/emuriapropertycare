...
<div class="row">
    <div class="col-lg-8 mx-auto grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Residential Size Tier</h4>
                
                <form action="{{ route('admin.residential-tiers.update', $residentialTier) }}" method="POST" class="forms-sample">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('tier_name') is-invalid @enderror" 
                               id="tier_name" name="tier_name" value="{{ old('tier_name', $residentialTier->tier_name) }}" required>
                        @error('tier_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('min_units') is-invalid @enderror" 
                                       id="min_units" name="min_units" value="{{ old('min_units', $residentialTier->min_units) }}" required>
                                @error('min_units')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('max_units') is-invalid @enderror" 
                                       id="max_units" name="max_units" value="{{ old('max_units', $residentialTier->max_units) }}">
                                @error('max_units')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control @error('size_factor') is-invalid @enderror" 
                               id="size_factor" name="size_factor" value="{{ old('size_factor', $residentialTier->size_factor) }}" required>
                        @error('size_factor')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  id="description" name="description" rows="3">{{ old('description', $residentialTier->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="is_active" value="1" 
                                   {{ old('is_active', $residentialTier->is_active) ? 'checked' : '' }}>
                            Active
                        </label>
                    </div>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary me-2">
                            <i class="mdi mdi-content-save"></i> Update Tier
                        </button>
