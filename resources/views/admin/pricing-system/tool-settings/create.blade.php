            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.tool-settings.store') }}" method="POST" class="forms-sample">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="{{ old('quantity', 1) }}" min="1" max="999" required onwheel="this.blur()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" class="form-control @error('sort_order') is-invalid @enderror" id="sort_order" name="sort_order" value="{{ old('sort_order', 0) }}" onwheel="this.blur()">
