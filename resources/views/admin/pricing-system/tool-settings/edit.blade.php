            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.tool-settings.update', $toolSetting) }}" method="POST" class="forms-sample">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" class="form-control @error('sort_order') is-invalid @enderror" id="sort_order" name="sort_order" value="{{ old('sort_order', $toolSetting->sort_order) }}">
