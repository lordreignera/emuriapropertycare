...
<div class="row">
    <div class="col-lg-8 mx-auto grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Create System</h4>

                <form action="{{ route('admin.systems.store') }}" method="POST" class="forms-sample">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" max="20" class="form-control @error('weight') is-invalid @enderror" id="weight" name="weight" value="{{ old('weight', 0) }}" required>
                        <small class="text-muted">Relative importance in the CPI formula (0–20). Structural = 20, Garage = 4.</small>
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="is_core" value="1" {{ old('is_core') ? 'checked' : '' }}>
                            Core building system
                        </label>
                    </div>

                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary me-2"><i class="mdi mdi-content-save"></i> Create System</button>
