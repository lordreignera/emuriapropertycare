...
<div class="row">
    <div class="col-lg-8 mx-auto grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Create Commercial Size Setting</h4>
                
                <form action="{{ route('admin.commercial-settings.store') }}" method="POST" class="forms-sample">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('data_type') is-invalid @enderror" 
                            ...
                            <option value="decimal" {{ old('data_type', 'decimal') == 'decimal' ? 'selected' : '' }}>Decimal</option>
