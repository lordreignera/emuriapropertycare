...
<div class="row">
    <div class="col-lg-8 mx-auto grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Create Age Bracket</h4>
                
                <form action="{{ route('admin.age-brackets.store') }}" method="POST" class="forms-sample">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('bracket_name') is-invalid @enderror" 
                               id="bracket_name" name="bracket_name" value="{{ old('bracket_name') }}" required>
                        @error('bracket_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('min_age') is-invalid @enderror" 
                                       id="min_age" name="min_age" value="{{ old('min_age') }}" required>
                                @error('min_age')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('max_age') is-invalid @enderror" 
                                       id="max_age" name="max_age" value="{{ old('max_age') }}">
                                @error('max_age')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary me-2">
                            <i class="mdi mdi-content-save"></i> Create Bracket
                        </button>
