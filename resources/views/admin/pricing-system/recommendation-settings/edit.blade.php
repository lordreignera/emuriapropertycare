            ...
            <div class="card-body">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control @error('system_id') is-invalid @enderror" id="system_id" name="system_id">
                                ...
                                @foreach(($systems ?? collect()) as $system)
                                    <option value="{{ $system->id }}" {{ (string) old('system_id', $recommendationSetting->system_id) === (string) $system->id ? 'selected' : '' }}>{{ $system->name }}</option>
                                @endforeach
                            </select>
                ...
                <script>
                    (function () {
                        ...
                        const selectedSubsystemId = "{{ old('subsystem_id', $recommendationSetting->subsystem_id) }}";
