...
class BDCSettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $settings = [
            ...
            [
                'setting_key' => 'rate_per_km',
                'setting_label' => 'Rate per Km',
                'setting_description' => 'Travel charge per kilometre used for travel-based BDC calculation',
                'setting_value' => 1.50,
                'unit' => '$/km',
                'setting_type' => 'rate',
                'is_active' => true,
            ...
            [
                'setting_key' => 'rate_per_minute',
                'setting_label' => 'Rate per Minute',
                'setting_description' => 'Travel charge per minute used for travel-based BDC calculation',
                'setting_value' => 1.65,
                'unit' => '$/min',
                'setting_type' => 'rate',
                'is_active' => true,
